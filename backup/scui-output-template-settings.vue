...
export default {
  ...
  methods: {
    ...
    customUpload(option) {
      ...
      fetch((this.$CONFIG && this.$CONFIG.API_URL ? this.$CONFIG.API_URL : '') + '/upload-template', {
        method: 'POST',
        body: formData
      })
        .then(async res => {
    ...
    loadTemplates() {
      fetch((this.$CONFIG && this.$CONFIG.API_URL ? this.$CONFIG.API_URL : '') + '/list-templates')
        .then(res => res.json())
        .then(data => {
          if (data.code === 200) {
    ...
    deleteTemplate(row) {
      fetch((this.$CONFIG && this.$CONFIG.API_URL ? this.$CONFIG.API_URL : '') + '/delete-template', {
        method: 'POST',
